...
public class WaveFile {
    ...
    public void SaveAudio(string filepath, int numberSamples, int channels, float[] samplesData, int sampleRate) {

        sampleCount = numberSamples;
        bigBuff = new float[samplesData.Length];

        Array.Copy(samplesData, 0, bigBuff, 0, samplesData.Length);
    ...
    private void WriteHeader(FileStream fileStream, int samples, int channels, int hz) {
